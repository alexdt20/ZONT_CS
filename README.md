...
Раздел **Команды** https://github.com/alexdt20/ZONT_CS/tree/master/01_Команды содержит управляющие команды для конфигурирования и настройки устройства через Терминал/СМС
